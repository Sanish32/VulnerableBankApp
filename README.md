...
1. Clone the directory. After cloning, I have noticed that unknown indentation comes in line 149 of ``views.py`` file inside ``pages`` folder. Fix the indentation.
